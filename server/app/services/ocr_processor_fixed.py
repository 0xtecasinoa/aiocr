        ...
        try:
            ...
            if product_data:
                ...
                extracted_data = ExtractedData(
                    ...
                    major_category=structured.get('major_category') or structured.get('category', ''),
                    ...
                    ip_name=structured.get('ip_name') or structured.get('brand', ''),
                    ...
                    quantity_per_pack=structured.get('quantity_per_pack') or str(structured.get('case_quantity', '')),
                    ...
                    case_pack_quantity=self._safe_int_convert(structured.get('case_pack_quantity') or structured.get('case_quantity')),
                    single_product_size=structured.get('single_product_size') or structured.get('product_size') or structured.get('dimensions', ''),
                    inner_box_size=structured.get('inner_box_size') or structured.get('package_size', ''),
                    ...
                    protective_film_material=structured.get('protective_film_material') or structured.get('packaging_material') or structured.get('package_type', ''),
                    country_of_origin=structured.get('country_of_origin') or structured.get('origin', ''),
